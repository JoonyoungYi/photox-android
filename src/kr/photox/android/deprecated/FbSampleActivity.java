...
public class FbSampleActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setUserInfoChangedCallback(new LoginButton.UserInfoChangedCallback() {
            ...
            public void onUserInfoFetched(GraphUser user) {
                FbSampleActivity.this.user = user;
                updateUI();
    ...
    private void onSessionStateChange(Session session, SessionState state, Exception exception) {
        if (pendingAction != PendingAction.NONE &&
                ...
                new AlertDialog.Builder(FbSampleActivity.this)
    ...
    private void showPickerFragment(PickerFragment<?> fragment) {
        fragment.setOnErrorListener(new PickerFragment.OnErrorListener() {
            ...
            public void onError(PickerFragment<?> pickerFragment, FacebookException error) {
                ...
                Toast toast = Toast.makeText(FbSampleActivity.this, text, Toast.LENGTH_SHORT);
                toast.show();
            }
        });
